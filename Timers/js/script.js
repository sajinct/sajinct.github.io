...
document.getElementById('btn-1500').addEventListener('click', function() {
    timer.setDuration(1500000); // 1500 seconds
	timer.reset();
    timer.start();
});

document.getElementById('btn-300').addEventListener('click', function() {
    timer.setDuration(300000); // 300 seconds
	timer.reset();
    timer.start();
});

document.getElementById('btn-900').addEventListener('click', function() {
    timer.setDuration(900000); // 900 seconds
	timer.reset();
    timer.start();
});
